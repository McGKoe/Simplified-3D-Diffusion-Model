                        ...
                        for (int j = 0; j < maxsize + 2; j++) 
			{
                                for (int k = 0; k < maxsize + 2; k++) 
				{
					...
					if(	(i == 0) || (i == maxsize + 1) ||
						...
						// zero the partition
					else if((i == 1 + (maxsize + 2)/2) && (j >= 1 + (maxsize * .25)))
						bitmap[i][j][k] = 0;
					else
						bitmap[i][j][k] = 1;
				}
                                ...
                                for (int j=1; j<maxsize+1; j++)
                                {
									...
									if(bitmap[i][j][k] == 1 && bitmap[l][m][n] == 1)
									{
                                                                        	if (    ( ( i == l )   && ( j == m )   && ( k == n+1) ) ||
                                                                                	...
                                                                                	( ( i == l-1 ) && ( j == m )   && ( k == n)   ) )
                                                                        	{
                                                                                	        double change = (cube[i-1][j-1][k-1] - cube[l-1][m-1][n-1]) * DTerm;
                                                                                	        cube[i-1][j-1][k-1] = cube[i-1][j-1][k-1] - change;
                                                                                	        cube[l-1][m-1][n-1] = cube[l-1][m-1][n-1] + change;
                                                                        	}
									}
                                                                }
                                                        }
